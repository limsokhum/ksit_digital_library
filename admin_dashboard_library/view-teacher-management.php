                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header d-flex justify-content-between py-3">
                            <a class="m-0 btn btn-primary float-start font-weight-bold text-light"
                                href="list-teacher.php"><i class="fa-solid fa-backward"></i> Back</a>
                        </div>
                                ...
                                <form action="" method="post" enctype="multipart/form-data">
                                    ...
                                    <ul class="list-group list-group-flush">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-10">
                                                    ...
                                                    <span class="detail-digital mx-4">
                                                        <?php echo $row_select_teacher['firstname'] .$row_select_teacher['lastname']?>
                                                    </span>
                                                </div>
                                            </div>
                                        ...
                                        <li class="list-group-item">
                                            <div class="row">
                                                <div class="col-sm-2">
                                                    <span class="list-staf fw-bolder">អ៊ីម៉ែល</span>
                                                </div>
                                                <div class="col-sm-10">
                                                    <span class="text-primary fw-bolder"> :*</span>
                                                    <span
                                        ...
                                        <li class="list-group-item">
                                            <div class="row">
                                                <div class="col-sm-2">
                                                    <span class="detail-digital fw-bolder">លេខទូរស័ព្ទ</span>
                                                </div>
                                                <div class="col-sm-10">
                                                    <span class="text-primary fw-bolder"> :*</span>
                                                    <span
