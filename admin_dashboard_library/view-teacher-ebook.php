...
<?php
if(isset($_GET['id'])){
    $view_teacher_ebook = $_GET['id'];

    $query_view_teacher_ebook = "SELECT * FROM digitalbook_tb WHERE (((teacher_mail = '$email') AND (digital_book='e-book'))) AND (id='$view_teacher_ebook')";
    
    $result_view_teacher_ebook = $conn ->query($query_view_teacher_ebook);

    if($result_view_teacher_ebook->num_rows>0){
        
        while($row_select_teacher_ebook = $result_view_teacher_ebook -> fetch_assoc()){
           ?>
                                ...
                                <form action="" method="post" enctype="multipart/form-data">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="title" class="form-control form-control" id=""
                                            value="<?php echo $row_select_teacher_ebook['title']?>">
                                    </div>
                                    <div class="form-group">
                                        <div class="row mb-3">
                                            <div class="col-sm-6">
                                                ...
                                                <input type="text" name="name_auther" class="form-control form-control"
                                                    id="" value="<?php echo $row_select_teacher_ebook['name_auther']?>">
                                            </div>
                                            <div class="col-sm-3">
                                                <label class="label-control" for=""
                                                ...
                                                <input type="date" name="date" class="form-control form-control" id=""
                                                    aria-describedby=""
                                                    value="<?php echo $row_select_teacher_ebook['date']?>">
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-sm-6">
                                            ...
                                            <div class="radio-control">
                                                <input type="input" name="digital_book" class="form-control" id=""
                                                    value="<?php echo $row_select_teacher_ebook['digital_book']?>">
                                            </div>
                                            <!-- select_major -->
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <input type="hidden" name="teacher_mail" class="form-control form-control"
                                                id="" value="<?php echo $row_select_teacher['mail']?>">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea name="abstract" id="" cols="30" rows="10"
                                            ...
                                            <?php echo $row_select_teacher_ebook['abstract']?>
                                    </textarea>
                                    </div>
                                    <div class="form-group">
                                        <div class="wrapper">
                                            <div class="upload-files">
                                                <div class="select-image">
                                                    <div class="img-areas" data-img="">
                                                        <?php
                                                        foreach (json_decode($row_select_teacher_ebook["image"]) as $image) : ?>
