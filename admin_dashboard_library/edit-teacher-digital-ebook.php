...
if(isset($_GET['id'])){
    ...
    if(isset($_POST['submit'])){
        ...
        if($file==NULL && $imageName_one==NULL && $imageName_two==NULL){
            $sql = "UPDATE digitalbook_tb SET title='$title',name_auther='$name_auther',date='$date',select_major='$select_major',digital_book='$digital_book',abstract='$abstract',comment='$comment',keyword='$keyword' WHERE id = $query_edit_digital_book_id";
        }
        elseif($file!=NULL && $imageName_one==NULL && $imageName_two==NULL){
                ...
                //-- move the uploaded (temporary) file to the specified destination --//
                    if (move_uploaded_file($file, $destination)) {
                        $sql = "UPDATE digitalbook_tb SET title='$title',name_auther='$name_auther',date='$date',select_major='$select_major',digital_book='$digital_book',abstract='$abstract',comment='$comment',keyword='$keyword',name='$filename' WHERE id = $query_edit_digital_book_id";
                        }
                }
            }elseif($file==NULL && $imageName_one!=NULL && $imageName_two==NULL){
                $sql = "UPDATE digitalbook_tb SET title='$title',name_auther='$name_auther',date='$date',select_major='$select_major',digital_book='$digital_book',abstract='$abstract',comment='$comment',keyword='$keyword',image_one='$filesArray_one' WHERE id = $query_edit_digital_book_id";
            }elseif($file==NULL && $imageName_one==NULL && $imageName_two!=NULL){
                $sql = "UPDATE digitalbook_tb SET title='$title',name_auther='$name_auther',date='$date',select_major='$select_major',digital_book='$digital_book',abstract='$abstract',comment='$comment',keyword='$keyword',image_two='$filesArray_two' WHERE id = $query_edit_digital_book_id";
                
            }elseif($file==NULL && $imageName_one!=NULL && $imageName_two!=NULL){
                $sql = "UPDATE digitalbook_tb SET title='$title',name_auther='$name_auther',date='$date',select_major='$select_major',digital_book='$digital_book',abstract='$abstract',comment='$comment',keyword='$keyword',image_one='$filesArray_one',image_two='$filesArray_two' WHERE id = $query_edit_digital_book_id";
                ...
                //-- move the uploaded (temporary) file to the specified destination --//
                    ...
                    if (move_uploaded_file($file, $destination)) {
                        $sql = "UPDATE digitalbook_tb SET title='$title',name_auther='$name_auther',date='$date',select_major='$select_major',digital_book='$digital_book',abstract='$abstract',comment='$comment',keyword='$keyword',image_one='$filesArray_one',name='$filename' WHERE id = $query_edit_digital_book_id";
                        }
                }
            }elseif($file!=NULL && $imageName_one==NULL && $imageName_two!=NULL){
                if (!in_array($extension, ['zip', 'pdf', 'docx'])) {
                ...
                //-- move the uploaded (temporary) file to the specified destination --//
                    ...
                    if (move_uploaded_file($file, $destination)) {
                        $sql = "UPDATE digitalbook_tb SET title='$title',name_auther='$name_auther',date='$date',select_major='$select_major',digital_book='$digital_book',abstract='$abstract',comment='$comment',keyword='$keyword',image_two='$filesArray_two',name='$filename' WHERE id = $query_edit_digital_book_id";
                        }
                }
            }else{
                if (!in_array($extension, ['zip', 'pdf', 'docx'])) {
                ...
                //-- move the uploaded (temporary) file to the specified destination --//
                    ...
                    if (move_uploaded_file($file, $destination)) {
                        $sql = "UPDATE digitalbook_tb SET title='$title',name_auther='$name_auther',date='$date',select_major='$select_major',digital_book='$digital_book',abstract='$abstract',comment='$comment',keyword='$keyword',image_one='$filesArray_one',image_two='$filesArray_two',name='$filename' WHERE id = $query_edit_digital_book_id";
                        }
                }
            }
            ...
            if ($result_edit_digital==TRUE) {
                            ...
                            document.location.href = 'teacher-add-digital.php';
                            </script>
                            ";
                        }
...
if(isset($_GET['id'])){
    ...
    $query_teacher_digital_ebook = "SELECT * FROM digitalbook_tb WHERE (((teacher_mail = '$email') AND (digital_book='e-book'))) AND (id='$edit_teacher_digital_ebook')";
    ...
    if($result_teacher_digital_ebook->num_rows>0){
        while($row_teacher_digital_ebook = $result_teacher_digital_ebook->fetch_assoc()){
            ...
            $detailse = strtr(html_entity_decode($row_teacher_digital_ebook['comment']),$transe);
                                    ...
                                    <div class="form-group">
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-3">
                                                ...
                                                <input type="date" name="date"
                                                    value='<?php echo $row_teacher_digital_ebook["date"]?>'
                                        ...
                                        <div class="row mb-3">
                                            <div class="col-sm-4">
                                                ...
                                                <div class="radio-control">
                                                    <?php
                                                    if($row_teacher_digital_ebook['digital_book']=='e-book'){
                                                        ?>
                                                    ...
                                                    ?>
                                                    <?php
                                                    if($row_teacher_digital_ebook['digital_book']=='e-project'){
                                                        ?>
                                                    <input type="radio" name="digital_book" class="" id=""
                                                    ...
                                                    ?>
                                                    <?php
                                                    if($row_teacher_digital_ebook['digital_book']=='e-journal'){
                                                        ?>
                                                    <input type="radio" name="digital_book" class="" id=""
                                        ...
                                        <div class="row mb-3">
                                            <div class="col-sm-4">
                                                ...
                                                <div class="my-2">
                                                    <?php
                                                        foreach (json_decode($row_teacher_digital_ebook["image_one"]) as $image_one) : ?>
                                            ...
                                            <div class="col-sm-4">
                                                ...
                                                <div class="my-2 d-flex">
                                                    <?php
                                                        foreach (json_decode($row_teacher_digital_ebook["image_two"]) as $image_two) : ?>
                                                    ...
                                                    <div class="select-file">
                                                        <div class="file-areas" data-img="">
                                                            <h4>File Uploaded :<span class="detail-digital mx-4 h5"><a
                                                                        class=""
                                                                        href="view-digital-ebook.php?file_id_view=<?php echo $row_teacher_digital_ebook['id'] ?>"
                                                                        target="_blank"><?php echo $row_teacher_digital_ebook['name']?></a></span>
                                                            </h4>
                                        ...
                                        <div class="form-group mt-5">
                                            <label class="label-control" for=""
                                                style="font-family:'Koulen', sans-serif;">មតិយលបល់
                                                <spatn class=" text-danger">:*
                                                </spatn>
                                            </label>
                                            <textarea name="comment" id="" cols="12" rows="8"
