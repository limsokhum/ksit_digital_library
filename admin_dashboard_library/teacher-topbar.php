...
<nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
    <h4 class="font-weight-bold"><?php echo $row_select_teacher['major_title']?></h4>
    ...
    <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item dropdown no-arrow">
            ...
            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown"
                aria-haspopup="true" aria-expanded="false">
                <span
                    class="mr-2 d-none d-lg-inline text-gray-600 small text-uppercase"><?php echo $row_select_teacher['firstname'];  ?>
                    <?php echo $row_select_teacher['lastname']?></span>
            ...
            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">
                ...
                <a class="dropdown-item" href="logout-teacher.php">
