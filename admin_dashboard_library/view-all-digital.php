                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header d-flex justify-content-between py-3">
                            <a class="m-0 btn btn-primary float-start font-weight-bold text-light" href="index.php"><i
                                ...
                                <form action="" method="post" enctype="multipart/form-data">
                                    <ul class="list-group list-group-flush">
                                        <li class="list-group-item">
                                            <div class="row">
                                                <div class="col-sm-2">
                                                    <span class="list-staf fw-bolder">ប្រធានបទ Digital Book</span>
                                                </div>
                                                <div class="col-sm-10">
                                        ...
                                        <li class="list-group-item">
                                            <div class="row">
                                                <div class="col-sm-2">
                                                    <span class="list-staf fw-bolder">រូប Cover សៀវភៅ</span>
                                                </div>
                                                <div class="col-sm-10">
                                                    <?php
                                                        foreach (json_decode($row_select_digital_book["image_one"]) as $image) : ?>
