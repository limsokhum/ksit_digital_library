        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Add e-Journal</h1>
                        ...
                        <div class="card-body p-0">
                            <div class="p-5">
                                ...
                                <div class="alert alert-success alert-dismissible">
                                    ...
                                    <strong>You Add Journal Success!</strong> .You Can Fine on List Journal
                                </div>
                                <?php 
                                ...
                                <form class="user">
                                    <div class="form-group">
                                        <label class="label-control" for="">Title e-Journals</label>
                                        <input type="text" class="form-control form-control" id="" aria-describedby=""
                                            placeholder="e-Journal Title...">
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-6">
                                                ...
                                                <input type="number" class="form-control form-control" id=""
                                                    aria-describedby="" placeholder="Page e-Journal...">
                                            </div>
                                        </div>
