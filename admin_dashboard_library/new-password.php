            ...
            <div class="col-xl-10 col-lg-12 col-md-9">
                ...
                <div class="card o-hidden border-0 shadow-lg my-5">
                    ...
                    ?>
                                    ...
                                    <form method="POST" active="login.php">
                                        <div class="form-group">
                                            <input type="password" name="password"
                                                class="form-control form-control-user" id="exampleInputEmail"
                                                aria-describedby="emailHelp" placeholder="លេខសម្ងាត់ថ្មី...">
                                        </div>
                                        <div class="form-group">
                                            <input type="password" name="cpassword"
                                                class="form-control form-control-user" id="exampleInputEmail"
                                                aria-describedby="emailHelp" placeholder="បញ្ជាក់លេខសម្ងាត់...">
                                        </div>
                                        <button class="btn" style="background-color: #336666; color: white;"
                                            type="submit" name="change-password"><i
                                                class="fa-solid fa-right-to-bracket"></i> ផ្លាស់ប្ដូលេខសម្ងាត់</button>
                                    ...
                                    <hr>
                                    <div class="text-center">
                                        ប្រសិនបើអ្នកមានគណនេយ្យ<a class="small" href="login.php"> ចុកចូលនៅទីនេះ!</a>
                                    </div>
                                </div>
                            </div>
                        </div>
