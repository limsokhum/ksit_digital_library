                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="control-profile my-2">
                                            <?php
                                             ...
                                             FROM member INNER JOIN major_tb ON member.select_major=major_tb.id  WHERE (major_title = 'វិទ្យាសាស្រ្ដជលផល') AND (select_role='គ្រូបង្រៀន')";
                                            ...
                                            // teacher_tb.teacher_status,major_tb.major_title FROM teacher_tb INNER JOIN major_tb ON teacher_tb.select_major = major_tb.id WHERE (major_title = 'វិទ្យាសាស្រ្ដជលផល') AND (select_role='គ្រូបង្រៀន')";
