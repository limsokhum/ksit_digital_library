    ...
    <div class="container">
        ...
        <div class="card mt-2" style="width: 100%; box-shadow: 0 6px 15px grey; outline:#242424;">
            <div class="row container-header">
                <div class="col-sm-6"
                    style="background-image: url('assets/images/banner-journal.png'); background-repeat: no-repeat; background-size: cover; border-radius: 4px;">
                    <div class="card-body">
                ...
                <div class="container row my-4">
                    <div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 col-xxl-8">
                        <div id="myTable" class="card mb-2" style="width: 100%;">
                            ...
                            $result = mysqli_query($conn,"SELECT * FROM `digitalbook_tb` WHERE status=1 && digital_book='e-journal' LIMIT $offset,
                            ...
                            <div class="card-body news-announcements">
                                <div class="img-news">
                                    ...
                                    if($row["image_one"]==''){
                                        ?>
                                    <img src="" alt="Null image E-Journal">
                                    <?php
                                    }else{
