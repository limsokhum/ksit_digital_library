                    ...
                    <div class="col-sm-8">
                        <div class="container">
                            ...
                            <?php
                             ...
                             FROM member INNER JOIN major_tb ON member.select_major=major_tb.id  WHERE (major_title = 'បច្ចេកវិទ្យាកុំព្យូទ័រ') AND (select_role='បុគ្គលិកដំណាងដេប៉ាតឺម៉ង់')";
                            ...
                            // teacher_tb.teacher_status,major_tb.major_title FROM teacher_tb INNER JOIN major_tb ON teacher_tb.select_major = major_tb.id WHERE (major_title = 'បច្ចេកវិទ្យាកុំព្យូទ័រ') AND (select_role='បុគ្គលិកដំណាងដេប៉ាតឺម៉ង់')";
                            ...
                            <div class="card my-2" style="width: 100%; border-color: orange;">
                                ...
                                <a href="view-teach-science-page.php?id=<?php echo $row_select_represiontative['id']?>">
                                    <div class="container">
                                        <div class="card-body">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="control-profile my-2">
                                            <?php
                                             ...
                                             FROM member INNER JOIN major_tb ON member.select_major=major_tb.id  WHERE (major_title = 'បច្ចេកវិទ្យាកុំព្យូទ័រ') AND (select_role='គ្រូបង្រៀន')";
                                            // $select_teacher_staff = "SELECT teacher_tb.id, teacher_tb.teacher_id,teacher_tb.firstname,
                                            // teacher_tb.lastname,teacher_tb.teacher_mail,teacher_tb.phone,teacher_tb.select_major,
                                            // teacher_tb.specialty,teacher_tb.select_role,teacher_tb.image,teacher_tb.teacher_detials,
                                            // teacher_tb.teacher_status,major_tb.major_title FROM teacher_tb INNER JOIN major_tb ON teacher_tb.select_major = major_tb.id WHERE (major_title = 'បច្ចេកវិទ្យាកុំព្យូទ័រ') AND (select_role='គ្រូបង្រៀន')";
