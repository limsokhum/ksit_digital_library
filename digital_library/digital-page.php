            ...
            <div class="modal fade" id="exampleModalTwo" tabindex="-1" aria-labelledby="exampleModalLabel"
                ...
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        ...
                        <div class="modal-body d-flex align-items-center justify-content-center"
                            style="background-color: #dedede;">
                            <?php foreach (json_decode($row_digital["image_two"]) as $image_two) : ?>
                            <img src="../admin_dashboard_library/uploads/<?php echo $image_two; ?>"
