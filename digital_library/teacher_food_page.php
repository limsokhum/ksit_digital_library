                    ...
                    <div class="col-sm-8">
                        <div class="container">
                            ...
                            <?php
                             ...
                             FROM member INNER JOIN major_tb ON member.select_major=major_tb.id  WHERE (major_title = 'បច្ចេកវិទ្យាអាហារ') AND (select_role='បុគ្គលិកដំណាងដេប៉ាតឺម៉ង់')";
                            ...
                            // teacher_tb.teacher_status,major_tb.major_title FROM teacher_tb INNER JOIN major_tb ON teacher_tb.select_major = major_tb.id WHERE (major_title = 'បច្ចេកវិទ្យាអាហារ') AND (select_role='បុគ្គលិកដំណាងដេប៉ាតឺម៉ង់')";
                            ...
                            <div class="card my-2" style="width: 100%; border-color: orange;">
                                ...
                                <a
                                    href="view-teacher-repre-foot-page.php?id=<?php echo $row_select_represiontative['id']?>">
                                    <div class="container">
                                        <div class="card-body">
