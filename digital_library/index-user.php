...
<head>
    ...
    <!-- Icon Favicon -->
    <link rel="shortcut icon" type="image/png" href="assets/images/logo-around.png">;
...
?>
    ...
    function onclickShow() {
        document.getElementById('teacher_advisor').style.display = "block";
    }

    function onclickRemove() {
        document.getElementById('teacher_advisor').style.display = "none";
    }
    </script>
    <script>
    function onclickshowTeacherAdvisor() {
